            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                <div className="hidden md:flex">
                  <div
                    className={`w-9 h-9 rounded-full flex items-center justify-center border-2 overflow-hidden relative ${
                      userRole === USER_ROLES.SEEKER
                        ? "border-sky-200"
                        : "border-emerald-200"
                    } ${
                ...
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden z-50 animate-fadeIn">
                  ...
                  <div className="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-sky-50 to-emerald-50">
                    <div className="flex items-start">
                      {/* Avatar in Dropdown */}
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mr-3 flex-shrink-0 relative overflow-hidden ${
                          userRole === USER_ROLES.SEEKER
                  ...
                  <div className="py-2">
                    ...
                    {profileData?.resumeURL && (
                      <button
                        onClick={async (e) => {
                          ...
                          try {
                            const success = downloadFileFromCloudinary(
                              profileData.resumeURL,
                      ...
                      >
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-emerald-100 to-emerald-50 text-emerald-600 flex items-center justify-center mr-3 flex-shrink-0">
                          {resumeLoading ? (
                    ...
                    >
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-red-100 to-pink-100 flex items-center justify-center mr-3 flex-shrink-0">
                        <svg
